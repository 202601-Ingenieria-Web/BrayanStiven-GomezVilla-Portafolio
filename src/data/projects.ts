...
export const projectItems: ProjectItem[] = [
    {
        ...
        detailedDescription:
            "Proyecto orientado al análisis automatizado de documentos empresariales del sector financiero. La solución integró Langflow, DataStax Astra DB, OpenAI y Python para procesar información, vectorizar contenido relevante y generar respuestas alineadas con criterios de inversión previamente definidos.",
        image: "/images/projects/rag-financiero.jpg",
        technologies: ["Python", "Langflow", "DataStax Astra DB", "OpenAI", "RAG"],
    },
    {
        ...
        detailedDescription:
            "Proyecto de ciencia de datos enfocado en el preprocesamiento de textos, limpieza de información, vectorización y entrenamiento de modelos de aprendizaje automático para clasificar sentimientos en reseñas de productos.",
    ...
    },
    {
        ...
        detailedDescription:
            "Proyecto desarrollado para clasificar imágenes de celulares en las categorías roto y sin daño. Se trabajó con procesamiento de imágenes, preparación de datos, aumento de datos y entrenamiento de modelos de clasificación.",
    ...
    },
    {
        ...
        shortDescription:
            "Aplicación de escritorio para la gestión de inventarios, ventas, compras, reportes y roles administrativos.",
        detailedDescription:
    ...
    },
    {
        ...
        shortDescription:
            "Aplicación móvil para aprender palabras nuevas en español.",
        detailedDescription:
    ...
    },
    {
        ...
        shortDescription:
            "Aplicación móvil para subastar artículos de segunda mano dentro de la comunidad de la UdeA.",
        detailedDescription:
        ...
        technologies: ["Flutter", "Spring Boot", "PostgreSQL", "Firebase Auth", "Gemini API"],
    },
];